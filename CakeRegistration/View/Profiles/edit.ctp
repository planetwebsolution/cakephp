...
echo $this->Form->input('email', array('label' => array('class' => '', 'text' => 'Enter Email'), 'class' => 'form-control',array('readonly' => 'readonly')));
...
?>
                    ...
                    <img id="img" src="<?php echo $this->request->data['Profile']['image']; ?>" width="100px" height="100px"/>  
<?php                    
